...
export const generateDailyBriefing = async () => {
  ...
  const prompt = `You are an AI daily briefing assistant. Look at my pending tasks today and provide a concise, friendly, and motivational plain-English briefing summarizing what I have to do. Be professional yet encouraging.\n\nHere are my tasks:\n${taskListText}`;
